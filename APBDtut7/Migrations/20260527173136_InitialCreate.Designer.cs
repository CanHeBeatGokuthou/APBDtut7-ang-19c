...
namespace APBDtut7.Migrations
{
    ...
    [Migration("20260527173136_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApbdTutorial7.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("ApbdTutorial7.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApbdTutorial7.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApbdTutorial7.Models.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 27, 12, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("ApbdTutorial7.Models.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApbdTutorial7.Models.Component", b =>
                {
                    b.HasOne("ApbdTutorial7.Models.ComponentManufacturer", "Manufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ManufacturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApbdTutorial7.Models.ComponentType", "Type")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("ApbdTutorial7.Models.PCComponent", b =>
                {
                    b.HasOne("ApbdTutorial7.Models.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApbdTutorial7.Models.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
